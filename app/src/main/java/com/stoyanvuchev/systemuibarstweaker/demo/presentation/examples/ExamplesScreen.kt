...
/**
 * A screen containing examples of different scenarios for tweaking the System UI Bars.
 *
...
fun ExamplesScreen(
    ...
    ResponsiveScaffold(
            ...
            LargeTopAppBar(
                title = {
                    ...
                    Text(
                        ...
                        text = stringResource(id = R.string.examples_screen_label),
        ...
        LazyVerticalGrid(
            ...
            item(
                ...
                content = {
                    ...
                    Text(
                        ...
                        text = stringResource(id = R.string.examples_screen_introduction),
            ...
            itemsIndexed(
                items = Example.examplesList,
                key = { _, example -> "example_$example" },
                itemContent = { _, example ->

                    ExamplesScreenItem(
                        example = example,
                        onNavigateToExampleScreen = onNavigateToScreen
                    )
